...
<template>
	<div>
			...
			<template #title>
				<a-row type="flex" align="middle">
					<a-col :span="24" :md="12" class="col-info">
						<a-avatar :size="74" shape="square" src="images/img-profile-head.jpg" />
						<div class="avatar-info">
							<h4 class="font-semibold m-0">刘小年</h4>
							<p>复旦大学 / 大三</p>
						</div>
					</a-col>
					<a-col :span="24" :md="12" style="display: flex; align-items: center; justify-content: flex-end">
						<a-radio-group v-model="profileHeaderBtns" size="small">
							<a-radio-button value="overview">我的主页</a-radio-button>
							<a-radio-button value="teams">其他设置</a-radio-button>
							<a-radio-button value="projects">消息</a-radio-button>
						</a-radio-group>
					</a-col>
				</a-row>
			</template>
		...
		<a-row type="flex" :gutter="24">
			...
			<a-col :span="24" type="flex"  class="mb-24">
